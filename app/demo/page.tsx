      ...
      component: (
        <div className="space-y-4">
          <CommandBlock
            ...
            output="â Package installed successfully!\nð¦ Added 15 packages in 2.3s"
            status="success"
            timestamp={new Date()}
            duration={2300}
          />
          <CommandBlock
            command="yarn build"
            output="ð Building production bundle...\nâ¨ Build completed in 4.2s"
            status="success"
