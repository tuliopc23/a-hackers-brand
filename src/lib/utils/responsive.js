...
// StatusBar layout utilities
export const statusBarVariants = tv({
	base: 'pb-[var(--status-bar-height,2.5rem)]',
	variants: {
		spacing: {
			none: 'pb-[var(--status-bar-height,2.5rem)]',
			sm: 'pb-[calc(var(--status-bar-height,2.5rem)+0.5rem)]',
			md: 'pb-[calc(var(--status-bar-height,2.5rem)+1rem)]',
			lg: 'pb-[calc(var(--status-bar-height,2.5rem)+1.5rem)]'
		},
		container: {
			true: 'min-h-[calc(100vh-var(--status-bar-height,2.5rem))]'
		}
	},
	defaultVariants: {
		spacing: 'none'
