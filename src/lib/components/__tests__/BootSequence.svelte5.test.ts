...
describe('BootSequence Component (Svelte 5)', () => {
	const defaultMessages = [
		{ text: 'Initializing system...', delay: 100, type: 'info' as const },
		{ text: 'Loading modules...', delay: 200, type: 'info' as const, progress: true },
		{ text: 'System ready!', delay: 150, type: 'success' as const },
		{ text: 'Warning: Low memory', delay: 100, type: 'warning' as const },
		{ text: 'Boot complete', delay: 300, type: 'system' as const }
	];
	...
	describe('Props and Configuration', () => {
		...
		it('should handle messages array', () => {
			const customMessages = [
				{ text: 'Loading...', delay: 100, type: 'info' as const },
				{ text: 'Complete!', delay: 200, type: 'success' as const }
			];
