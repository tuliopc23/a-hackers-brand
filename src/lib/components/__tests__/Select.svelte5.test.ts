...
describe('Select Component (Svelte 5)', () => {
	...
	describe('CSS Class Generation', () => {
		it('should generate correct trigger button classes', () => {
			...
			expectClassesToContain(trigger, ['relative', 'w-full', 'cursor-pointer', 'glass-medium', 'px-4']);
		});
		...
		it('should generate correct dropdown classes', () => {
			...
			expectClassesToContain(dropdown, ['absolute', 'w-full', 'glass-heavy', 'shadow-2xl']);
		});
	...
	describe('Accessibility', () => {
		...
		it('should support keyboard navigation in dropdown', () => {
			const options = [createMockElement(), createMockElement(), createMockElement()];
