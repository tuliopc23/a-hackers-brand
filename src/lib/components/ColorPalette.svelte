<script lang="ts">
	...
	const bubbleTeaColors: ColorSwatchData[] = [
		{ name: 'Soft Pink', hex: '#ff6b9d', category: 'Primary', description: 'Primary brand color' },
		{ name: 'Vibrant Purple', hex: '#c44af2', category: 'Primary', description: 'Secondary brand color' },
		{ name: 'Bright Blue', hex: '#4fa8ff', category: 'Primary', description: 'Accent color' },
		{ name: 'Modern Cyan', hex: '#4dd8da', category: 'Primary', description: 'Info color' },
		{ name: 'Fresh Green', hex: '#6bcf7f', category: 'Status', description: 'Success state' },
		{ name: 'Warm Yellow', hex: '#ffd23a', category: 'Status', description: 'Warning state' },
		{ name: 'Coral Orange', hex: '#ff8c42', category: 'Status', description: 'Caution state' },
		{ name: 'Soft Red', hex: '#ff6b6b', category: 'Status', description: 'Error state' },
		...
		// Glow variants
		{ name: 'Glow Pink', hex: '#ff85b3', category: 'Glow Effects', description: 'Enhanced pink for glow effects' },
		{ name: 'Glow Purple', hex: '#d666ff', category: 'Glow Effects', description: 'Enhanced purple for glow effects' },
		{ name: 'Glow Blue', hex: '#66c3ff', category: 'Glow Effects', description: 'Enhanced blue for glow effects' },
		{ name: 'Glow Cyan', hex: '#66e6ea', category: 'Glow Effects', description: 'Enhanced cyan for glow effects' },
		{ name: 'Glow Green', hex: '#85d99b', category: 'Glow Effects', description: 'Enhanced green for glow effects' },
		{ name: 'Glow Orange', hex: '#ffad66', category: 'Glow Effects', description: 'Enhanced orange for glow effects' }
	];
...
<div class={cn('space-y-6', className)} {...restProps}>
	...
	{#if showCategories}
		{#each categories as category}
			<div class="space-y-3">
				<h3 class="text-lg font-semibold text-white/90 border-b border-white/10 pb-2">
					{category}
				</h3>

				<div class={getLayoutClasses()}>
					{#each displayColors.filter((c) => c.category === category) as color}
						<ColorSwatch
							{color}
							{layout}
							{interactive}
