	...
	<div class={cn('flex items-center justify-between p-4 border-b rounded-t-lg', currentVariant.header)}>
		<div class="flex items-center gap-4">
			...
			<button
				...
				onkeydown={(e) => e.key === 'Enter' && (showFilters = !showFilters)(e)}
				class={cn(
				...
				<tr>
					...
					{#each columns() as column (column.id || column)}
						<th
							...
							onkeydown={(e) => e.key === 'Enter' && column.sortable && handleSort(column.key)(e)}
						>
		...
		<div class={cn('flex items-center justify-between p-4 border-t rounded-b-lg', currentVariant.header)}>
			...
			<div class="flex items-center gap-2">
				<button
					...
					onkeydown={(e) => e.key === 'Enter' && (currentPage = Math.max(1, currentPage - 1))(e)}
				...
				<button
					...
					onkeydown={(e) => e.key === 'Enter' && (currentPage = Math.min(totalPages, currentPage + 1))(e)}
