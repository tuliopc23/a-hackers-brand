<script lang="ts">
    ...
    interface DropdownItem {
        label: string;
        value: string;
        icon?: import("svelte").ComponentType | null;
        disabled?: boolean;
        divider?: boolean;
    }
    ...
    const variants = {
        ...
        terminal: {
            trigger:
                "bg-gray-900/90 border-green-400/40 hover:border-green-400 text-green-400",
        ...
        neon: {
            trigger:
                "bg-black border-pink-500/50 hover:border-pink-500 text-pink-400",
...
>
    <button
        ...
        use:magneticHover={{ enabled: true, strength: 0.1 }}
        aria-expanded={open}
        aria-haspopup="true"
    >
