<script lang="ts">
	...
	const examples = {
		basic: '<LiquidTerminal>\n  Content\n</LiquidTerminal>',
		variants: '<LiquidTerminal>\n  Content\n</LiquidTerminal>',
		advanced:
			"<LiquidTerminal\n\ttitle={''}\n\tcommands={''}\n\tautoPlay={true}\n\ttheme={undefined}\n>\n\tAdvanced Usage\n</LiquidTerminal>"
	};
	...
	const propsData = [
		...
		{
			name: 'theme',
			type: "'liquid' | 'plasma' | 'neural' | 'quantum'",
			optional: true,
			default: 'undefined',
			description: 'theme property'
		},
		{
			name: 'enableLiquidFlow',
			type: 'boolean',
			optional: true,
			default: 'false',
			description: 'enableLiquidFlow property'
		},
		{
		...
		},
		{
			...
			optional: true,
			default: 'false',
			description: 'enableWaveform property'
		},
		{
			name: 'enableHologram',
			type: 'boolean',
			optional: true,
			default: 'false',
			description: 'enableHologram property'
		},
		{
			name: 'children',
			type: 'any',
	...
	const playgroundProps = {
		...
		theme: {
			type: 'string',
			default: undefined,
			options: ['liquid', 'plasma', 'neural', 'quantum']
		},
		enableLiquidFlow: {
			type: 'boolean',
			default: false,
...
<svelte:head>
	<title>LiquidTerminal Component - A Hacker's Brand</title>
	<meta name="description" content="LiquidTerminal component with liquid glass effects and terminal aesthetics." />
</svelte:head>
...
<div class="docs-content">
	...
	<section class="mb-12">
		<div class="flex items-start justify-between mb-6">
			<div>
				<h1 class="text-4xl lg:text-5xl font-bold mb-4">LiquidTerminal</h1>
	...
	<section class="mb-16">
		...
		<ComponentPlayground component={LiquidTerminal} props={playgroundProps} componentName="LiquidTerminal" />
	</section>
