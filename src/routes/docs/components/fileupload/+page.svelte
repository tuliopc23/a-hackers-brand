<script lang="ts">
	...
	const examples = {
		basic: '<FileUpload>\n  Content\n</FileUpload>',
		variants:
			"<FileUpload variant='default'>\n  Default\n</FileUpload>\n<FileUpload variant='glass'>\n  Glass\n</FileUpload>\n<FileUpload variant='terminal'>\n  Terminal\n</FileUpload>",
		advanced:
			"<FileUpload\n\tmultiple={true}\n\taccept={''}\n\tmaxSize={0}\n\tmaxFiles={0}\n>\n\tAdvanced Usage\n</FileUpload>"
	};
	...
	const propsData = [
		...
		},
		{
			...
			optional: true,
			default: 'false',
			description: 'showPreview property'
		},
		{
			name: 'uploadUrl',
			type: 'string',
			optional: true,
			default: "''",
			description: 'uploadUrl property'
		},
		{
			name: 'autoUpload',
			type: 'boolean',
			optional: true,
			default: 'false',
			description: 'autoUpload property'
		},
		{
			name: 'class',
			type: 'string',
...
<svelte:head>
	<title>FileUpload Component - A Hacker's Brand</title>
	<meta name="description" content="FileUpload component with liquid glass effects and terminal aesthetics." />
</svelte:head>
...
<div class="docs-content">
	...
	<section class="mb-12">
		<div class="flex items-start justify-between mb-6">
			<div>
				<h1 class="text-4xl lg:text-5xl font-bold mb-4">FileUpload</h1>
		...
		<div class="p-8 bg-slate-900/50 backdrop-blur-sm rounded-xl border border-white/10">
			<div class="flex flex-wrap gap-4 items-center justify-center">
				...
				<FileUpload variant="secondary">Secondary</FileUpload>
				<FileUpload variant="ghost">Ghost</FileUpload>
			</div>
		</div>
	</section>
	...
	<section class="mb-16">
		...
		<ComponentPlayground component={FileUpload} props={playgroundProps} componentName="FileUpload" />
	</section>
