<script lang="ts">
	...
	const propsData = [
		...
		},
		{
			...
			optional: true,
			default: 'false',
			description: 'showPercentage property'
		},
		{
			name: 'indeterminate',
			type: 'boolean',
...
<svelte:head>
	<title>Progress Component - A Hacker's Brand</title>
	<meta name="description" content="Progress indicator with liquid animations and customizable styling." />
</svelte:head>
...
<div class="docs-content">
	...
	<section class="mb-12">
		<div class="flex items-start justify-between mb-6">
			<div>
				<h1 class="text-4xl lg:text-5xl font-bold mb-4">Progress</h1>
	...
	<section class="mb-16">
		...
		<ComponentPlayground component={Progress} props={playgroundProps} componentName="Progress" />
	</section>
