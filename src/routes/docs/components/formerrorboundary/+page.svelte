<script lang="ts">
	...
	import FormErrorBoundary from '$lib/components/FormErrorBoundary.svelte';
	...
	const examples = {
		basic: '<FormErrorBoundary>\n  Content\n</FormErrorBoundary>',
		variants:
			"<FormErrorBoundary variant='glass'>\n  Glass\n</FormErrorBoundary>\n<FormErrorBoundary variant='terminal'>\n  Terminal\n</FormErrorBoundary>\n<FormErrorBoundary variant='minimal'>\n  Minimal\n</FormErrorBoundary>",
		advanced:
			"<FormErrorBoundary\n\terrors={undefined}\n\tshowSummary={true}\n\tvariant={'default'}\n\tanimate={true}\n>\n\tAdvanced Usage\n</FormErrorBoundary>"
	};
	...
	const propsData = [
		...
		},
		{
			...
			optional: true,
			default: 'false',
			description: 'showSummary property'
		},
		{
			name: 'variant',
		...
		},
		{
			...
			optional: true,
			default: 'undefined',
			description: 'onDismiss property'
		},
		{
			name: 'class',
			type: 'string',
...
<svelte:head>
	<title>FormErrorBoundary Component - A Hacker's Brand</title>
	<meta name="description" content="FormErrorBoundary component with liquid glass effects and terminal aesthetics." />
</svelte:head>
...
<div class="docs-content">
	...
	<section class="mb-12">
		<div class="flex items-start justify-between mb-6">
			<div>
				<h1 class="text-4xl lg:text-5xl font-bold mb-4">FormErrorBoundary</h1>
		...
		<div class="p-8 bg-slate-900/50 backdrop-blur-sm rounded-xl border border-white/10">
			<div class="flex flex-wrap gap-4 items-center justify-center">
				<FormErrorBoundary>Preview</FormErrorBoundary>
				<FormErrorBoundary variant="secondary">Secondary</FormErrorBoundary>
				<FormErrorBoundary variant="ghost">Ghost</FormErrorBoundary>
			</div>
		</div>
	</section>
	...
	<section class="mb-16">
		...
		<ComponentPlayground component={FormErrorBoundary} props={playgroundProps} componentName="FormErrorBoundary" />
	</section>
						...
						<div class="grid lg:grid-cols-2 gap-8">
							<div class="space-y-4">
								...
								<div class="p-6 bg-slate-800/50 rounded-lg border border-white/10">
									...
									<FormErrorBoundary>Example</FormErrorBoundary>
								</div>
							</div>
							<div class="space-y-4">
