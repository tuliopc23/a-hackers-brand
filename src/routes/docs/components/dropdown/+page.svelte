<script lang="ts">
	...
	const examples = {
		basic: '<Dropdown>\n  Content\n</Dropdown>',
		variants:
			"<Dropdown variant='glass'>\n  Glass\n</Dropdown>\n<Dropdown variant='terminal'>\n  Terminal\n</Dropdown>\n<Dropdown variant='liquid'>\n  Liquid\n</Dropdown>\n<Dropdown variant='neon'>\n  Neon\n</Dropdown>",
		advanced:
			"<Dropdown\n\titems={undefined}\n\ttrigger={''}\n\tvalue={''}\n\tvariant={'default'}\n>\n\tAdvanced Usage\n</Dropdown>"
	};
	...
	const propsData = [
		...
		},
		{
			...
			optional: true,
			default: "''",
			description: 'triggerClass property'
		},
		{
			name: 'menuClass',
			type: 'string',
			optional: true,
			default: "''",
			description: 'menuClass property'
		},
		{
			name: 'onselect',
...
<svelte:head>
	<title>Dropdown Component - A Hacker's Brand</title>
	<meta name="description" content="Dropdown component with liquid glass effects and terminal aesthetics." />
</svelte:head>
...
<div class="docs-content">
	...
	<section class="mb-12">
		<div class="flex items-start justify-between mb-6">
			<div>
				<h1 class="text-4xl lg:text-5xl font-bold mb-4">Dropdown</h1>
		...
		<div class="p-8 bg-slate-900/50 backdrop-blur-sm rounded-xl border border-white/10">
			<div class="flex flex-wrap gap-4 items-center justify-center">
				...
				<Dropdown variant="secondary">Secondary</Dropdown>
				<Dropdown variant="ghost">Ghost</Dropdown>
			</div>
		</div>
	</section>
	...
	<section class="mb-16">
		...
		<ComponentPlayground component={Dropdown} props={playgroundProps} componentName="Dropdown" />
	</section>
