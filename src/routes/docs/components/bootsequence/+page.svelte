<script lang="ts">
	...
	const examples = {
		basic: '<BootSequence>\n  Content\n</BootSequence>',
		variants:
			"<BootSequence variant='classic'>\n  Classic\n</BootSequence>\n<BootSequence variant='modern'>\n  Modern\n</BootSequence>\n<BootSequence variant='matrix'>\n  Matrix\n</BootSequence>\n<BootSequence variant='terminal'>\n  Terminal\n</BootSequence>",
		advanced:
	...
	const propsData = [
		...
		{
			name: 'variant',
			type: "'classic' | 'modern' | 'matrix' | 'terminal'",
			optional: true,
			default: "'default'",
		...
		},
		{
			...
			optional: true,
			default: 'false',
			description: 'showCursor property'
		},
		{
			name: 'class',
			type: 'string',
	...
	const playgroundProps = {
		...
		variant: {
			type: 'string',
			default: 'default',
			options: ['classic', 'modern', 'matrix', 'terminal']
		},
		speed: {
			type: 'string',
			default: undefined,
...
<svelte:head>
	<title>BootSequence Component - A Hacker's Brand</title>
	<meta name="description" content="BootSequence component with liquid glass effects and terminal aesthetics." />
</svelte:head>
...
<div class="docs-content">
	...
	<section class="mb-12">
		<div class="flex items-start justify-between mb-6">
			<div>
				<h1 class="text-4xl lg:text-5xl font-bold mb-4">BootSequence</h1>
		...
		<div class="p-8 bg-slate-900/50 backdrop-blur-sm rounded-xl border border-white/10">
			<div class="flex flex-wrap gap-4 items-center justify-center">
				<BootSequence>Preview</BootSequence>
				<BootSequence variant="secondary">Secondary</BootSequence>
				<BootSequence variant="ghost">Ghost</BootSequence>
			</div>
		</div>
	</section>
	...
	<section class="mb-16">
		...
		<ComponentPlayground component={BootSequence} props={playgroundProps} componentName="BootSequence" />
	</section>
						...
						<div class="grid lg:grid-cols-2 gap-8">
							<div class="space-y-4">
								...
								<div class="p-6 bg-slate-800/50 rounded-lg border border-white/10">
									...
									<BootSequence>Example</BootSequence>
								</div>
							</div>
							<div class="space-y-4">
