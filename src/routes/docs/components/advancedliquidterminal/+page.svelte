<script lang="ts">
	...
	const examples = {
		basic: '<AdvancedLiquidTerminal>\n  Content\n</AdvancedLiquidTerminal>',
		variants: '<AdvancedLiquidTerminal>\n  Content\n</AdvancedLiquidTerminal>',
		advanced: '<AdvancedLiquidTerminal\n\n>\n\tAdvanced Usage\n</AdvancedLiquidTerminal>'
	};
...
<svelte:head>
	<title>AdvancedLiquidTerminal Component - A Hacker's Brand</title>
	<meta
		name="description"
		content="AdvancedLiquidTerminal component with liquid glass effects and terminal aesthetics."
	/>
</svelte:head>
...
<div class="docs-content">
	...
	<section class="mb-12">
		<div class="flex items-start justify-between mb-6">
			<div>
				<h1 class="text-4xl lg:text-5xl font-bold mb-4">AdvancedLiquidTerminal</h1>
