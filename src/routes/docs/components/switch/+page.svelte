<script lang="ts">
	...
	const propsData = [
		...
		},
		{
			...
			optional: true,
			default: 'false',
			description: 'onCheckedChange property'
		}
	];
...
<svelte:head>
	<title>Switch Component - A Hacker's Brand</title>
	<meta name="description" content="Switch component with liquid glass effects and terminal aesthetics." />
</svelte:head>
...
<div class="docs-content">
	...
	<section class="mb-12">
		<div class="flex items-start justify-between mb-6">
			<div>
				<h1 class="text-4xl lg:text-5xl font-bold mb-4">Switch</h1>
	...
	<section class="mb-16">
		...
		<ComponentPlayground component={Switch} props={playgroundProps} componentName="Switch" />
	</section>
