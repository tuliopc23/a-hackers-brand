<script lang="ts">
	...
	const propsData = [
		...
		},
		{
			...
			optional: true,
			default: "''",
			description: 'selectedItems property'
		},
		{
			name: 'loading',
			type: 'boolean',
		...
		},
		{
			...
			optional: true,
			default: '0',
			description: 'loadingCount property'
		},
		{
			name: 'emptyMessage',
			type: 'string',
		...
		},
		{
			...
			optional: true,
			default: "''",
			description: 'emptyIcon property'
		},
		{
			name: 'dividers',
			type: 'boolean',
...
<svelte:head>
	<title>List Component - A Hacker's Brand</title>
	<meta name="description" content="List component with liquid glass effects and terminal aesthetics." />
</svelte:head>
...
<div class="docs-content">
	...
	<section class="mb-12">
		<div class="flex items-start justify-between mb-6">
			<div>
				<h1 class="text-4xl lg:text-5xl font-bold mb-4">List</h1>
		...
		<div class="p-8 bg-slate-900/50 backdrop-blur-sm rounded-xl border border-white/10">
			<div class="flex flex-wrap gap-4 items-center justify-center">
				<List>Preview</List>
				<List variant="secondary">Secondary</List>
				<List variant="ghost">Ghost</List>
			</div>
		</div>
	</section>
	...
	<section class="mb-16">
		...
		<ComponentPlayground component={List} props={playgroundProps} componentName="List" />
	</section>
