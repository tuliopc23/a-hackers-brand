<script lang="ts">
	...
	const examples = {
		basic: '<Carousel>\n  Content\n</Carousel>',
		variants:
			"<Carousel variant='glass'>\n  Glass\n</Carousel>\n<Carousel variant='terminal'>\n  Terminal\n</Carousel>\n<Carousel variant='liquid'>\n  Liquid\n</Carousel>",
		advanced:
			'<Carousel\n\titems={undefined}\n\tcurrentIndex={0}\n\tautoPlay={true}\n\tautoPlayInterval={0}\n>\n\tAdvanced Usage\n</Carousel>'
	};
	...
	const propsData = [
		...
		},
		{
			...
			optional: true,
			default: '0',
			description: 'currentIndex property'
		},
		{
			name: 'autoPlay',
			type: 'boolean',
		...
		},
		{
			...
			optional: true,
			default: '0',
			description: 'autoPlayInterval property'
		},
		{
			name: 'showControls',
			type: 'boolean',
			optional: true,
			default: 'false',
			description: 'showControls property'
		},
		{
			name: 'showDots',
			type: 'boolean',
		...
		},
		{
			...
			optional: true,
			default: 'false',
			description: 'showProgress property'
		},
		{
			name: 'loop',
			type: 'boolean',
		...
		},
		{
			...
			optional: true,
			default: '0',
			description: 'itemsPerView property'
		},
		{
			name: 'gap',
			type: "'sm' | 'md' | 'lg'",
		...
		},
		{
			...
			optional: true,
			default: 'false',
			description: 'touchEnabled property'
		},
		{
			name: 'class',
			type: 'string',
...
<svelte:head>
	<title>Carousel Component - A Hacker's Brand</title>
	<meta name="description" content="Carousel component with liquid glass effects and terminal aesthetics." />
</svelte:head>
...
<div class="docs-content">
	...
	<section class="mb-12">
		<div class="flex items-start justify-between mb-6">
			<div>
				<h1 class="text-4xl lg:text-5xl font-bold mb-4">Carousel</h1>
		...
		<div class="p-8 bg-slate-900/50 backdrop-blur-sm rounded-xl border border-white/10">
			<div class="flex flex-wrap gap-4 items-center justify-center">
				...
				<Carousel variant="secondary">Secondary</Carousel>
				<Carousel variant="ghost">Ghost</Carousel>
			</div>
		</div>
	</section>
	...
	<section class="mb-16">
		...
		<ComponentPlayground component={Carousel} props={playgroundProps} componentName="Carousel" />
	</section>
