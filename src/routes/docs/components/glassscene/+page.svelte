<script lang="ts">
	...
	import GlassScene from '$lib/components/GlassScene.svelte';
	...
	const propsData = [
		...
		{
			name: 'enableLiquidEffects',
			type: 'boolean',
			optional: true,
			default: 'false',
			description: 'enableLiquidEffects property'
		},
		{
			...
			optional: true,
			default: 'false',
			description: 'enableParticles property'
		},
		{
			name: 'enableBloom',
			type: 'boolean',
			optional: true,
			default: 'false',
			description: 'enableBloom property'
		},
		{
			name: 'theme',
			type: "'terminal' | 'cyberpunk' | 'neural' | 'quantum'",
			optional: true,
			default: 'undefined',
	...
	const playgroundProps = {
		...
		theme: {
			type: 'string',
			default: undefined,
			options: ['terminal', 'cyberpunk', 'neural', 'quantum']
		}
	};
...
<svelte:head>
	<title>GlassScene Component - A Hacker's Brand</title>
	<meta name="description" content="GlassScene component with liquid glass effects and terminal aesthetics." />
</svelte:head>
...
<div class="docs-content">
	...
	<section class="mb-12">
		<div class="flex items-start justify-between mb-6">
			<div>
				<h1 class="text-4xl lg:text-5xl font-bold mb-4">GlassScene</h1>
		...
		<div class="p-8 bg-slate-900/50 backdrop-blur-sm rounded-xl border border-white/10">
			<div class="flex flex-wrap gap-4 items-center justify-center">
				<GlassScene>Preview</GlassScene>
				<GlassScene variant="secondary">Secondary</GlassScene>
				<GlassScene variant="ghost">Ghost</GlassScene>
			</div>
		</div>
	</section>
	...
	<section class="mb-16">
		...
		<ComponentPlayground component={GlassScene} props={playgroundProps} componentName="GlassScene" />
	</section>
