<script lang="ts">
	...
	const propsData = [
		{
			name: 'variant',
			type: "'default' | 'glass' | 'glass-subtle' | 'glass-heavy' | 'terminal' | 'liquid' | 'jelly'",
			optional: true,
			default: "'default'",
	...
	const playgroundProps = {
		variant: {
			type: 'string',
			default: 'default',
			options: ['default', 'glass', 'glass-subtle', 'glass-heavy', 'terminal', 'liquid', 'jelly']
		},
		blur: {
			type: 'string',
			default: undefined,
...
<svelte:head>
	<title>Card Component - A Hacker's Brand</title>
	<meta name="description" content="Versatile container component with liquid glass aesthetics and hover effects." />
</svelte:head>
...
<div class="docs-content">
	...
	<section class="mb-12">
		<div class="flex items-start justify-between mb-6">
			<div>
				<h1 class="text-4xl lg:text-5xl font-bold mb-4">Card</h1>
	...
	<section class="mb-16">
		...
		<ComponentPlayground component={Card} props={playgroundProps} componentName="Card" />
	</section>
