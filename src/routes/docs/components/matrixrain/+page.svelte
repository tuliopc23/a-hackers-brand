<script lang="ts">
	...
	const examples = {
		basic: '<MatrixRain>\n  Content\n</MatrixRain>',
		variants:
			"<MatrixRain variant='classic'>\n  Classic\n</MatrixRain>\n<MatrixRain variant='hacker'>\n  Hacker\n</MatrixRain>\n<MatrixRain variant='cyber'>\n  Cyber\n</MatrixRain>\n<MatrixRain variant='liquid'>\n  Liquid\n</MatrixRain>",
		advanced:
	...
	const propsData = [
		{
			name: 'variant',
			type: "'classic' | 'hacker' | 'cyber' | 'liquid'",
			optional: true,
			default: "'default'",
		...
		{
			name: 'characters',
			type: "'matrix' | 'binary' | 'hex' | 'code'",
			optional: true,
			default: 'undefined',
			description: 'characters property'
		},
		{
			name: 'glowEffect',
			type: 'boolean',
			optional: true,
			default: 'false',
			description: 'glowEffect property'
		},
		{
			name: 'fadeEffect',
			type: 'boolean',
			optional: true,
			default: 'false',
			description: 'fadeEffect property'
		},
		{
			name: 'class',
			type: 'string',
	...
	const playgroundProps = {
		variant: {
			type: 'string',
			default: 'default',
			options: ['classic', 'hacker', 'cyber', 'liquid']
		},
		speed: {
			type: 'string',
			default: undefined,
		...
		characters: {
			type: 'string',
			default: undefined,
			options: ['matrix', 'binary', 'hex', 'code']
		},
		glowEffect: {
			type: 'boolean',
			default: false,
...
<svelte:head>
	<title>MatrixRain Component - A Hacker's Brand</title>
	<meta name="description" content="MatrixRain component with liquid glass effects and terminal aesthetics." />
</svelte:head>
...
<div class="docs-content">
	...
	<section class="mb-12">
		<div class="flex items-start justify-between mb-6">
			<div>
				<h1 class="text-4xl lg:text-5xl font-bold mb-4">MatrixRain</h1>
		...
		<div class="p-8 bg-slate-900/50 backdrop-blur-sm rounded-xl border border-white/10">
			<div class="flex flex-wrap gap-4 items-center justify-center">
				<MatrixRain>Preview</MatrixRain>
				<MatrixRain variant="secondary">Secondary</MatrixRain>
				<MatrixRain variant="ghost">Ghost</MatrixRain>
			</div>
		</div>
	</section>
	...
	<section class="mb-16">
		...
		<ComponentPlayground component={MatrixRain} props={playgroundProps} componentName="MatrixRain" />
	</section>
