<script lang="ts">
	...
	const examples = {
		basic: '<Pagination>\n  Content\n</Pagination>',
		variants:
			"<Pagination variant='glass'>\n  Glass\n</Pagination>\n<Pagination variant='terminal'>\n  Terminal\n</Pagination>\n<Pagination variant='liquid'>\n  Liquid\n</Pagination>\n<Pagination variant='neon'>\n  Neon\n</Pagination>",
		advanced:
			"<Pagination\n\tcurrentPage={0}\n\ttotalPages={0}\n\tsiblingCount={0}\n\tvariant={'default'}\n>\n\tAdvanced Usage\n</Pagination>"
	};
	...
	const propsData = [
		...
		},
		{
			...
			optional: true,
			default: '0',
			description: 'siblingCount property'
		},
		{
			name: 'variant',
		...
		},
		{
			...
			optional: true,
			default: 'false',
			description: 'showFirstLast property'
		},
		{
			name: 'class',
			type: 'string',
...
<svelte:head>
	<title>Pagination Component - A Hacker's Brand</title>
	<meta name="description" content="Pagination component with liquid glass effects and terminal aesthetics." />
</svelte:head>
...
<div class="docs-content">
	...
	<section class="mb-12">
		<div class="flex items-start justify-between mb-6">
			<div>
				<h1 class="text-4xl lg:text-5xl font-bold mb-4">Pagination</h1>
		...
		<div class="p-8 bg-slate-900/50 backdrop-blur-sm rounded-xl border border-white/10">
			<div class="flex flex-wrap gap-4 items-center justify-center">
				...
				<Pagination variant="ghost">Ghost</Pagination>
			</div>
		</div>
	</section>
	...
	<section class="mb-16">
		...
		<ComponentPlayground component={Pagination} props={playgroundProps} componentName="Pagination" />
	</section>
