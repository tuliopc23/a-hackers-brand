<script lang="ts">
	...
	const examples = {
		basic: '<Slider>\n  Content\n</Slider>',
		variants:
			"<Slider variant='default'>\n  Default\n</Slider>\n<Slider variant='glass'>\n  Glass\n</Slider>\n<Slider variant='terminal'>\n  Terminal\n</Slider>",
		advanced: '<Slider\n\tvalue={0}\n\tmin={0}\n\tmax={0}\n\tstep={0}\n>\n\tAdvanced Usage\n</Slider>'
	};
	...
	const propsData = [
		...
		},
		{
			...
			optional: true,
			default: 'false',
			description: 'showMarks property'
		},
		{
			name: 'marks',
			type: 'number[]',
...
<svelte:head>
	<title>Slider Component - A Hacker's Brand</title>
	<meta name="description" content="Slider component with liquid glass effects and terminal aesthetics." />
</svelte:head>
...
<div class="docs-content">
	...
	<section class="mb-12">
		<div class="flex items-start justify-between mb-6">
			<div>
				<h1 class="text-4xl lg:text-5xl font-bold mb-4">Slider</h1>
		...
		<div class="p-8 bg-slate-900/50 backdrop-blur-sm rounded-xl border border-white/10">
			<div class="flex flex-wrap gap-4 items-center justify-center">
				...
				<Slider variant="ghost">Ghost</Slider>
			</div>
		</div>
	</section>
	...
	<section class="mb-16">
		...
		<ComponentPlayground component={Slider} props={playgroundProps} componentName="Slider" />
	</section>
