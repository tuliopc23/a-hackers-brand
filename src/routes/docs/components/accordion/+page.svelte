<script lang="ts">
	...
	const propsData = [
		...
		},
		{
			...
			optional: true,
			default: 'false',
			description: 'collapsible property'
		},
		{
			name: 'variant',
		...
		},
		{
			...
			optional: true,
			default: "''",
			description: 'defaultOpen property'
		},
		{
			name: 'class',
			type: 'string',
...
<svelte:head>
	<title>Accordion Component - A Hacker's Brand</title>
	<meta name="description" content="Collapsible content sections with smooth animations and keyboard support." />
</svelte:head>
...
<div class="docs-content">
	...
	<section class="mb-12">
		<div class="flex items-start justify-between mb-6">
			<div>
				<h1 class="text-4xl lg:text-5xl font-bold mb-4">Accordion</h1>
	...
	<section class="mb-16">
		...
		<ComponentPlayground component={Accordion} props={playgroundProps} componentName="Accordion" />
	</section>
