...
<svelte:head>
	<title>Input Component - A Hacker's Brand</title>
	<meta
		name="description"
		content="Elegant input field with liquid glass effects, floating labels, and comprehensive validation support."
	/>
</svelte:head>
...
<div class="docs-content">
	...
	<section class="mb-12">
		<div class="flex items-start justify-between mb-6">
			<div>
				<h1 class="text-4xl lg:text-5xl font-bold mb-4">Input</h1>
	...
	<section class="mb-16">
		...
		<ComponentPlayground component={Input} props={playgroundProps} componentName="Input" />
	</section>
