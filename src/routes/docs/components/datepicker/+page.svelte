<script lang="ts">
	...
	const examples = {
		basic: '<DatePicker>\n  Content\n</DatePicker>',
		variants:
			"<DatePicker variant='default'>\n  Default\n</DatePicker>\n<DatePicker variant='glass'>\n  Glass\n</DatePicker>\n<DatePicker variant='terminal'>\n  Terminal\n</DatePicker>",
		advanced:
			"<DatePicker\n\tvalue={''}\n\tvariant={'default'}\n\tsize={'md'}\n\terror={true}\n>\n\tAdvanced Usage\n</DatePicker>"
	};
...
<svelte:head>
	<title>DatePicker Component - A Hacker's Brand</title>
	<meta name="description" content="DatePicker component with liquid glass effects and terminal aesthetics." />
</svelte:head>
...
<div class="docs-content">
	...
	<section class="mb-12">
		<div class="flex items-start justify-between mb-6">
			<div>
				<h1 class="text-4xl lg:text-5xl font-bold mb-4">DatePicker</h1>
		...
		<div class="p-8 bg-slate-900/50 backdrop-blur-sm rounded-xl border border-white/10">
			<div class="flex flex-wrap gap-4 items-center justify-center">
				...
				<DatePicker variant="secondary">Secondary</DatePicker>
				<DatePicker variant="ghost">Ghost</DatePicker>
			</div>
		</div>
	</section>
	...
	<section class="mb-16">
		...
		<ComponentPlayground component={DatePicker} props={playgroundProps} componentName="DatePicker" />
	</section>
