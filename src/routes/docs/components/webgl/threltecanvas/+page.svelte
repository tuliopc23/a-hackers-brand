<script lang="ts">
	import { ThrelteCanvas } from '$lib/components';
	...
	const componentMeta = {
		name: 'ThrelteCanvas',
		description: '3D canvas wrapper for Three.js scenes',
		category: 'webgl',
		complexity: 'complex',
		since: '0.2.0'
	};
	...
	const basicExample = `<ThrelteCanvas />`;
	
	const advancedExample = `<script>
  import { ThrelteCanvas } from 'a-hackers-brand';
...
<div class="prose prose-invert max-w-none">
	...
	{#if playgroundProps.length > 0}
		<section class="mb-12">
			...
			<ComponentPlayground 
				componentName="ThrelteCanvas"
				component={ThrelteCanvas} 
	...
	<section>
		...
		<div class="flex flex-wrap gap-2">
			<a href="/docs/components/webgl" class="text-green-400 hover:underline">
				View all webgl components →
			</a>
		</div>
	</section>
</div>