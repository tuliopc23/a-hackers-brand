<script lang="ts">
	import { GlassScene } from '$lib/components';
	...
	const componentMeta = {
		name: 'GlassScene',
		description: '3D scene showcasing glass materials',
		category: 'webgl',
		complexity: 'complex',
		since: '0.2.0'
	};
	...
	const basicExample = `<GlassScene />`;
	
	const advancedExample = `<script>
  import { GlassScene } from 'a-hackers-brand';
