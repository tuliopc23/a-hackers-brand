<script lang="ts">
	...
	const propsData = [
		...
		{
			name: 'variant',
			type: "'glass' | 'terminal' | 'liquid' | 'dark'",
			optional: true,
			default: "'default'",
	...
	const playgroundProps = {
		...
		variant: {
			type: 'string',
			default: 'default',
			options: ['glass', 'terminal', 'liquid', 'dark']
		},
		delay: {
			type: 'number',
			default: 0,
...
<svelte:head>
	<title>Tooltip Component - A Hacker's Brand</title>
	<meta name="description" content="Tooltip component with liquid glass effects and terminal aesthetics." />
</svelte:head>
...
<div class="docs-content">
	...
	<section class="mb-12">
		<div class="flex items-start justify-between mb-6">
			<div>
				<h1 class="text-4xl lg:text-5xl font-bold mb-4">Tooltip</h1>
		...
		<div class="p-8 bg-slate-900/50 backdrop-blur-sm rounded-xl border border-white/10">
			<div class="flex flex-wrap gap-4 items-center justify-center">
				...
				<Tooltip variant="ghost">Ghost</Tooltip>
			</div>
		</div>
	</section>
	...
	<section class="mb-16">
		...
		<ComponentPlayground component={Tooltip} props={playgroundProps} componentName="Tooltip" />
	</section>
