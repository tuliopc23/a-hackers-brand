<script lang="ts">
	...
	const propsData = [
		...
		{
			name: 'status',
			type: "'idle' | 'running' | 'success' | 'error' | 'warning'",
			optional: true,
			default: 'undefined',
		...
		},
		{
			...
			optional: true,
			default: 'false',
			description: 'showPrompt property'
		},
		{
			name: 'showTimestamp',
			type: 'boolean',
			optional: true,
			default: 'false',
			description: 'showTimestamp property'
		},
		{
			name: 'interactive',
			type: 'boolean',
		...
		{
			name: 'theme',
			type: "'terminal' | 'cyberpunk' | 'matrix' | 'neural'",
			optional: true,
			default: 'undefined',
		...
		},
		{
			...
			optional: true,
			default: 'false',
			description: 'enableSound property'
		},
		{
			name: 'class',
			type: 'string',
	...
	const playgroundProps = {
		...
		status: {
			type: 'string',
			default: undefined,
			options: ['idle', 'running', 'success', 'error', 'warning']
		},
		showPrompt: {
			type: 'boolean',
			default: false,
		...
		theme: {
			type: 'string',
			default: undefined,
			options: ['terminal', 'cyberpunk', 'matrix', 'neural']
		},
		enableGlitch: {
			type: 'boolean',
			default: false,
...
<svelte:head>
	<title>CommandBlock Component - A Hacker's Brand</title>
	<meta name="description" content="CommandBlock component with liquid glass effects and terminal aesthetics." />
</svelte:head>
...
<div class="docs-content">
	...
	<section class="mb-12">
		<div class="flex items-start justify-between mb-6">
			<div>
				<h1 class="text-4xl lg:text-5xl font-bold mb-4">CommandBlock</h1>
		...
		<div class="p-8 bg-slate-900/50 backdrop-blur-sm rounded-xl border border-white/10">
			<div class="flex flex-wrap gap-4 items-center justify-center">
				<CommandBlock>Preview</CommandBlock>
				<CommandBlock variant="secondary">Secondary</CommandBlock>
				<CommandBlock variant="ghost">Ghost</CommandBlock>
			</div>
		</div>
	</section>
	...
	<section class="mb-16">
		...
		<ComponentPlayground component={CommandBlock} props={playgroundProps} componentName="CommandBlock" />
	</section>
