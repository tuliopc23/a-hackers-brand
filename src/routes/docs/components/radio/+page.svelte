<script lang="ts">
	...
	const examples = {
		basic: '<Radio>\n  Content\n</Radio>',
		variants:
			"<Radio variant='glass'>\n  Glass\n</Radio>\n<Radio variant='terminal'>\n  Terminal\n</Radio>\n<Radio variant='liquid'>\n  Liquid\n</Radio>\n<Radio variant='neon'>\n  Neon\n</Radio>",
		advanced:
			"<Radio\n\toptions={undefined}\n\tvalue={''}\n\tname={''}\n\tvariant={'default'}\n>\n\tAdvanced Usage\n</Radio>"
	};
...
<svelte:head>
	<title>Radio Component - A Hacker's Brand</title>
	<meta name="description" content="Radio component with liquid glass effects and terminal aesthetics." />
</svelte:head>
...
<div class="docs-content">
	...
	<section class="mb-12">
		<div class="flex items-start justify-between mb-6">
			<div>
				<h1 class="text-4xl lg:text-5xl font-bold mb-4">Radio</h1>
	...
	<section class="mb-16">
		...
		<ComponentPlayground component={Radio} props={playgroundProps} componentName="Radio" />
	</section>
