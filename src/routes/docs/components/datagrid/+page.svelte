...
<svelte:head>
	<title>DataGrid Component - A Hacker's Brand</title>
	<meta name="description" content="DataGrid component with liquid glass effects and terminal aesthetics." />
</svelte:head>
...
<div class="docs-content">
	...
	<section class="mb-12">
		<div class="flex items-start justify-between mb-6">
			<div>
				<h1 class="text-4xl lg:text-5xl font-bold mb-4">DataGrid</h1>
		...
		<div class="p-8 bg-slate-900/50 backdrop-blur-sm rounded-xl border border-white/10">
			<div class="flex flex-wrap gap-4 items-center justify-center">
				<DataGrid>Preview</DataGrid>
				<DataGrid variant="secondary">Secondary</DataGrid>
				<DataGrid variant="ghost">Ghost</DataGrid>
			</div>
		</div>
	</section>
	...
	<section class="mb-16">
		...
		<ComponentPlayground component={DataGrid} props={playgroundProps} componentName="DataGrid" />
	</section>
