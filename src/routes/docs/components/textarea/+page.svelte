<script lang="ts">
	...
	const propsData = [
		...
		},
		{
			...
			optional: true,
			default: '0',
			description: 'minHeight property'
		},
		{
			name: 'animate',
			type: 'boolean',
...
<svelte:head>
	<title>Textarea Component - A Hacker's Brand</title>
	<meta name="description" content="Textarea component with liquid glass effects and terminal aesthetics." />
</svelte:head>
...
<div class="docs-content">
	...
	<section class="mb-12">
		<div class="flex items-start justify-between mb-6">
			<div>
				<h1 class="text-4xl lg:text-5xl font-bold mb-4">Textarea</h1>
	...
	<section class="mb-16">
		...
		<ComponentPlayground component={Textarea} props={playgroundProps} componentName="Textarea" />
	</section>
