<script lang="ts">
	...
	import LazyThrelteCanvas from '$lib/components/LazyThrelteCanvas.svelte';
	...
	const examples = {
		basic: '<LazyThrelteCanvas>\n  Content\n</LazyThrelteCanvas>',
		variants: '<LazyThrelteCanvas>\n  Content\n</LazyThrelteCanvas>',
		advanced:
			'<LazyThrelteCanvas\n\twidth={0}\n\theight={0}\n\tscene={undefined}\n\tquality={undefined}\n>\n\tAdvanced Usage\n</LazyThrelteCanvas>'
	};
	...
	const propsData = [
		...
		},
		{
			...
			optional: true,
			default: 'false',
			description: 'autoRotate property'
		}
	];
	...
	const playgroundProps = {
		...
		scene: {
			type: 'string',
			default: undefined,
			options: ['glass', 'terminal', 'default']
		},
		quality: {
			type: 'string',
			default: undefined,
...
<svelte:head>
	<title>LazyThrelteCanvas Component - A Hacker's Brand</title>
	<meta name="description" content="LazyThrelteCanvas component with liquid glass effects and terminal aesthetics." />
</svelte:head>
...
<div class="docs-content">
	...
	<section class="mb-12">
		<div class="flex items-start justify-between mb-6">
			<div>
				<h1 class="text-4xl lg:text-5xl font-bold mb-4">LazyThrelteCanvas</h1>
		...
		<div class="p-8 bg-slate-900/50 backdrop-blur-sm rounded-xl border border-white/10">
			<div class="flex flex-wrap gap-4 items-center justify-center">
				<LazyThrelteCanvas>Preview</LazyThrelteCanvas>
				<LazyThrelteCanvas variant="secondary">Secondary</LazyThrelteCanvas>
				<LazyThrelteCanvas variant="ghost">Ghost</LazyThrelteCanvas>
			</div>
		</div>
	</section>
	...
	<section class="mb-16">
		...
		<ComponentPlayground component={LazyThrelteCanvas} props={playgroundProps} componentName="LazyThrelteCanvas" />
	</section>
						...
						<div class="grid lg:grid-cols-2 gap-8">
							<div class="space-y-4">
								...
								<div class="p-6 bg-slate-800/50 rounded-lg border border-white/10">
									...
									<LazyThrelteCanvas>Example</LazyThrelteCanvas>
								</div>
							</div>
							<div class="space-y-4">
