<script lang="ts">
	import { RetroText } from '$lib/components';
	...
	const componentMeta = {
		name: 'RetroText',
		description: 'Retro computer text with CRT effects',
		category: 'terminal',
		complexity: 'simple',
		since: '0.2.0'
	};
	...
	const basicExample = `<RetroText />`;
	
	const advancedExample = `<script>
  import { RetroText } from 'a-hackers-brand';
