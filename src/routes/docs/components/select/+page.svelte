<script lang="ts">
	...
	const examples = {
		basic: '<Select>\n  Content\n</Select>',
		variants:
			"<Select variant='default'>\n  Default\n</Select>\n<Select variant='glass'>\n  Glass\n</Select>\n<Select variant='terminal'>\n  Terminal\n</Select>\n<Select variant='liquid'>\n  Liquid\n</Select>",
		advanced:
			"<Select\n\toptions={undefined}\n\tvalue={''}\n\tplaceholder={''}\n\tdisabled={true}\n>\n\tAdvanced Usage\n</Select>"
	};
	...
	const propsData = [
		...
		{
			name: 'variant',
			type: "'default' | 'glass' | 'terminal' | 'liquid'",
			optional: true,
			default: "'default'",
		...
		},
		{
			...
			optional: true,
			default: "''",
			description: 'onValueChange property'
		}
	];
	...
	const eventsData = [
		...
		},
		{
			name: 'change',
			type: 'Event',
			description: 'Fired when input value is committed'
		}
	];
	...
	const playgroundProps = {
		...
		variant: {
			type: 'string',
			default: 'default',
			options: ['default', 'glass', 'terminal', 'liquid']
		},
		blur: {
			type: 'string',
			default: undefined,
...
<svelte:head>
	<title>Select Component - A Hacker's Brand</title>
	<meta name="description" content="Select component with liquid glass effects and terminal aesthetics." />
</svelte:head>
...
<div class="docs-content">
	...
	<section class="mb-12">
		<div class="flex items-start justify-between mb-6">
			<div>
				<h1 class="text-4xl lg:text-5xl font-bold mb-4">Select</h1>
	...
	<section class="mb-16">
		...
		<ComponentPlayground component={Select} props={playgroundProps} componentName="Select" />
	</section>
