<script lang="ts">
	...
	const examples = {
		basic: '<MultiSelect>\n  Content\n</MultiSelect>',
		variants:
			"<MultiSelect variant='default'>\n  Default\n</MultiSelect>\n<MultiSelect variant='glass'>\n  Glass\n</MultiSelect>\n<MultiSelect variant='terminal'>\n  Terminal\n</MultiSelect>",
		advanced:
			"<MultiSelect\n\toptions={undefined}\n\tvalue={''}\n\tplaceholder={''}\n\tvariant={'default'}\n>\n\tAdvanced Usage\n</MultiSelect>"
	};
	...
	const propsData = [
		...
		},
		{
			...
			optional: true,
			default: 'undefined',
			description: 'chipVariant property'
		},
		{
			name: 'closeOnSelect',
			type: 'boolean',
...
<svelte:head>
	<title>MultiSelect Component - A Hacker's Brand</title>
	<meta name="description" content="MultiSelect component with liquid glass effects and terminal aesthetics." />
</svelte:head>
...
<div class="docs-content">
	...
	<section class="mb-12">
		<div class="flex items-start justify-between mb-6">
			<div>
				<h1 class="text-4xl lg:text-5xl font-bold mb-4">MultiSelect</h1>
		...
		<div class="p-8 bg-slate-900/50 backdrop-blur-sm rounded-xl border border-white/10">
			<div class="flex flex-wrap gap-4 items-center justify-center">
				<MultiSelect>Preview</MultiSelect>
				<MultiSelect variant="secondary">Secondary</MultiSelect>
				<MultiSelect variant="ghost">Ghost</MultiSelect>
			</div>
		</div>
	</section>
	...
	<section class="mb-16">
		...
		<ComponentPlayground component={MultiSelect} props={playgroundProps} componentName="MultiSelect" />
	</section>
