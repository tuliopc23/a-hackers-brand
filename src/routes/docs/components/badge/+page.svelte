...
<svelte:head>
	<title>Badge Component - A Hacker's Brand</title>
	<meta name="description" content="Status indicators and labels with terminal-inspired styling and variants." />
</svelte:head>
...
<div class="docs-content">
	...
	<section class="mb-12">
		<div class="flex items-start justify-between mb-6">
			<div>
				<h1 class="text-4xl lg:text-5xl font-bold mb-4">Badge</h1>
	...
	<section class="mb-16">
		...
		<ComponentPlayground component={Badge} props={playgroundProps} componentName="Badge" />
	</section>
