<script lang="ts">
	...
	import RetroFuturisticText from '$lib/components/RetroFuturisticText.svelte';
	...
	const examples = {
		basic: '<RetroFuturisticText>\n  Content\n</RetroFuturisticText>',
		variants:
			"<RetroFuturisticText variant='macintosh'>\n  Macintosh\n</RetroFuturisticText>\n<RetroFuturisticText variant='dos'>\n  Dos\n</RetroFuturisticText>\n<RetroFuturisticText variant='amiga'>\n  Amiga\n</RetroFuturisticText>\n<RetroFuturisticText variant='commodore'>\n  Commodore\n</RetroFuturisticText>\n<RetroFuturisticText variant='atari'>\n  Atari\n</RetroFuturisticText>\n<RetroFuturisticText variant='crt'>\n  Crt\n</RetroFuturisticText>\n<RetroFuturisticText variant='phosphor'>\n  Phosphor\n</RetroFuturisticText>\n<RetroFuturisticText variant='matrix'>\n  Matrix\n</RetroFuturisticText>\n<RetroFuturisticText variant='cyberpunk'>\n  Cyberpunk\n</RetroFuturisticText>\n<RetroFuturisticText variant='vaporwave'>\n  Vaporwave\n</RetroFuturisticText>\n<RetroFuturisticText variant='neon'>\n  Neon\n</RetroFuturisticText>\n<RetroFuturisticText variant='hologram'>\n  Hologram\n</RetroFuturisticText>\n<RetroFuturisticText variant='glitch'>\n  Glitch\n</RetroFuturisticText>\n<RetroFuturisticText variant='terminal'>\n  Terminal\n</RetroFuturisticText>",
		advanced:
			"<RetroFuturisticText\n\ttext={''}\n\tvariant={'default'}\n\tsize={'md'}\n\tanimated={true}\n>\n\tAdvanced Usage\n</RetroFuturisticText>"
	};
	...
	const propsData = [
		...
		{
			name: 'variant',
			type: "'macintosh' | 'dos' | 'amiga' | 'commodore' | 'atari' | 'crt' | 'phosphor' | 'matrix' | 'cyberpunk' | 'vaporwave' | 'neon' | 'hologram' | 'glitch' | 'terminal'",
			optional: true,
			default: "'default'",
		...
		},
		{
			...
			optional: true,
			default: 'false',
			description: 'chromatic property'
		},
		{
			name: 'breathing',
			type: 'boolean',
...
<svelte:head>
	<title>RetroFuturisticText Component - A Hacker's Brand</title>
	<meta name="description" content="RetroFuturisticText component with liquid glass effects and terminal aesthetics." />
</svelte:head>
...
<div class="docs-content">
	...
	<section class="mb-12">
		<div class="flex items-start justify-between mb-6">
			<div>
				<h1 class="text-4xl lg:text-5xl font-bold mb-4">RetroFuturisticText</h1>
		...
		<div class="p-8 bg-slate-900/50 backdrop-blur-sm rounded-xl border border-white/10">
			<div class="flex flex-wrap gap-4 items-center justify-center">
				<RetroFuturisticText>Preview</RetroFuturisticText>
				<RetroFuturisticText variant="secondary">Secondary</RetroFuturisticText>
				<RetroFuturisticText variant="ghost">Ghost</RetroFuturisticText>
			</div>
		</div>
	</section>
	...
	<section class="mb-16">
		...
		<ComponentPlayground component={RetroFuturisticText} props={playgroundProps} componentName="RetroFuturisticText" />
	</section>
						...
						<div class="grid lg:grid-cols-2 gap-8">
							<div class="space-y-4">
								...
								<div class="p-6 bg-slate-800/50 rounded-lg border border-white/10">
									...
									<RetroFuturisticText>Example</RetroFuturisticText>
								</div>
							</div>
							<div class="space-y-4">
