<script lang="ts">
	...
	const examples = {
		basic: '<Drawer>\n  Content\n</Drawer>',
		variants:
			"<Drawer variant='glass'>\n  Glass\n</Drawer>\n<Drawer variant='terminal'>\n  Terminal\n</Drawer>\n<Drawer variant='liquid'>\n  Liquid\n</Drawer>",
		advanced:
			"<Drawer\n\topen={true}\n\tposition={undefined}\n\tsize={'md'}\n\tvariant={'default'}\n>\n\tAdvanced Usage\n</Drawer>"
	};
	...
	const propsData = [
		...
		},
		{
			...
			optional: true,
			default: 'false',
			description: 'showCloseButton property'
		},
		{
			name: 'persistent',
			type: 'boolean',
			optional: true,
			default: 'false',
			description: 'persistent property'
		},
		{
			name: 'class',
			type: 'string',
...
<svelte:head>
	<title>Drawer Component - A Hacker's Brand</title>
	<meta name="description" content="Drawer component with liquid glass effects and terminal aesthetics." />
</svelte:head>
...
<div class="docs-content">
	...
	<section class="mb-12">
		<div class="flex items-start justify-between mb-6">
			<div>
				<h1 class="text-4xl lg:text-5xl font-bold mb-4">Drawer</h1>
	...
	<section class="mb-16">
		...
		<ComponentPlayground component={Drawer} props={playgroundProps} componentName="Drawer" />
	</section>
