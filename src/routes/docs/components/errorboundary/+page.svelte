<script lang="ts">
	...
	const examples = {
		basic: '<ErrorBoundary>\n  Content\n</ErrorBoundary>',
		variants:
			"<ErrorBoundary variant='glass'>\n  Glass\n</ErrorBoundary>\n<ErrorBoundary variant='terminal'>\n  Terminal\n</ErrorBoundary>\n<ErrorBoundary variant='minimal'>\n  Minimal\n</ErrorBoundary>",
		advanced:
			"<ErrorBoundary\n\tfallback={undefined}\n\tonError={undefined}\n\tshowDetails={true}\n\tvariant={'default'}\n>\n\tAdvanced Usage\n</ErrorBoundary>"
	};
	...
	const propsData = [
		...
		},
		{
			...
			optional: true,
			default: 'false',
			description: 'retryable property'
		},
		{
			name: 'class',
			type: 'string',
...
<svelte:head>
	<title>ErrorBoundary Component - A Hacker's Brand</title>
	<meta name="description" content="ErrorBoundary component with liquid glass effects and terminal aesthetics." />
</svelte:head>
...
<div class="docs-content">
	...
	<section class="mb-12">
		<div class="flex items-start justify-between mb-6">
			<div>
				<h1 class="text-4xl lg:text-5xl font-bold mb-4">ErrorBoundary</h1>
		...
		<div class="p-8 bg-slate-900/50 backdrop-blur-sm rounded-xl border border-white/10">
			<div class="flex flex-wrap gap-4 items-center justify-center">
				...
				<ErrorBoundary variant="secondary">Secondary</ErrorBoundary>
				<ErrorBoundary variant="ghost">Ghost</ErrorBoundary>
			</div>
		</div>
	</section>
	...
	<section class="mb-16">
		...
		<ComponentPlayground component={ErrorBoundary} props={playgroundProps} componentName="ErrorBoundary" />
	</section>
						...
						<div class="grid lg:grid-cols-2 gap-8">
							<div class="space-y-4">
								...
								<div class="p-6 bg-slate-800/50 rounded-lg border border-white/10">
									...
									<ErrorBoundary>Example</ErrorBoundary>
								</div>
							</div>
							<div class="space-y-4">
