<script lang="ts">
	...
	import TerminalStartup from '$lib/components/TerminalStartup.svelte';
	...
	const examples = {
		basic: '<TerminalStartup>\n  Content\n</TerminalStartup>',
		variants:
			"<TerminalStartup variant='retro'>\n  Retro\n</TerminalStartup>\n<TerminalStartup variant='modern'>\n  Modern\n</TerminalStartup>\n<TerminalStartup variant='hacker'>\n  Hacker\n</TerminalStartup>\n<TerminalStartup variant='matrix'>\n  Matrix\n</TerminalStartup>",
		advanced:
	...
	const propsData = [
		{
			...
			optional: true,
			default: 'false',
			description: 'autoStart property'
		},
		{
			name: 'onComplete',
			type: '() => void',
			optional: true,
			default: 'undefined',
			description: 'onComplete property'
		},
		{
			name: 'variant',
			type: "'retro' | 'modern' | 'hacker' | 'matrix'",
			optional: true,
			default: "'default'",
	...
	const playgroundProps = {
		...
		variant: {
			type: 'string',
			default: 'default',
			options: ['retro', 'modern', 'hacker', 'matrix']
		},
		showBIOS: {
			type: 'boolean',
			default: false,
...
<svelte:head>
	<title>TerminalStartup Component - A Hacker's Brand</title>
	<meta name="description" content="TerminalStartup component with liquid glass effects and terminal aesthetics." />
</svelte:head>
...
<div class="docs-content">
	...
	<section class="mb-12">
		<div class="flex items-start justify-between mb-6">
			<div>
				<h1 class="text-4xl lg:text-5xl font-bold mb-4">TerminalStartup</h1>
		...
		<div class="p-8 bg-slate-900/50 backdrop-blur-sm rounded-xl border border-white/10">
			<div class="flex flex-wrap gap-4 items-center justify-center">
				<TerminalStartup>Preview</TerminalStartup>
				<TerminalStartup variant="secondary">Secondary</TerminalStartup>
				<TerminalStartup variant="ghost">Ghost</TerminalStartup>
			</div>
		</div>
	</section>
	...
	<section class="mb-16">
		...
		<ComponentPlayground component={TerminalStartup} props={playgroundProps} componentName="TerminalStartup" />
	</section>
						...
						<div class="grid lg:grid-cols-2 gap-8">
							<div class="space-y-4">
								...
								<div class="p-6 bg-slate-800/50 rounded-lg border border-white/10">
									...
									<TerminalStartup>Example</TerminalStartup>
								</div>
							</div>
							<div class="space-y-4">
