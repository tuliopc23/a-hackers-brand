<script lang="ts">
	...
	const examples = {
		basic: '<Skeleton>\n  Content\n</Skeleton>',
		variants:
			"<Skeleton variant='glass'>\n  Glass\n</Skeleton>\n<Skeleton variant='terminal'>\n  Terminal\n</Skeleton>\n<Skeleton variant='liquid'>\n  Liquid\n</Skeleton>\n<Skeleton variant='neon'>\n  Neon\n</Skeleton>",
		advanced:
			"<Skeleton\n\tvariant={'default'}\n\ttype={undefined}\n\tlines={0}\n\tanimated={true}\n>\n\tAdvanced Usage\n</Skeleton>"
	};
	...
	const playgroundProps = {
		...
		type: {
			type: 'string',
			default: undefined,
			options: ['text', 'avatar', 'card', 'button', 'image', 'paragraph']
		},
		lines: {
			type: 'number',
			default: 0,
...
<svelte:head>
	<title>Skeleton Component - A Hacker's Brand</title>
	<meta name="description" content="Skeleton component with liquid glass effects and terminal aesthetics." />
</svelte:head>
...
<div class="docs-content">
	...
	<section class="mb-12">
		<div class="flex items-start justify-between mb-6">
			<div>
				<h1 class="text-4xl lg:text-5xl font-bold mb-4">Skeleton</h1>
	...
	<section class="mb-16">
		...
		<ComponentPlayground component={Skeleton} props={playgroundProps} componentName="Skeleton" />
	</section>
