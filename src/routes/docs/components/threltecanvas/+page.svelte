<script lang="ts">
	...
	const examples = {
		basic: '<ThrelteCanvas>\n  Content\n</ThrelteCanvas>',
		variants: '<ThrelteCanvas>\n  Content\n</ThrelteCanvas>',
		advanced: '<ThrelteCanvas\n\twidth={0}\n\theight={0}\n>\n\tAdvanced Usage\n</ThrelteCanvas>'
	};
...
<svelte:head>
	<title>ThrelteCanvas Component - A Hacker's Brand</title>
	<meta name="description" content="ThrelteCanvas component with liquid glass effects and terminal aesthetics." />
</svelte:head>
...
<div class="docs-content">
	...
	<section class="mb-12">
		<div class="flex items-start justify-between mb-6">
			<div>
				<h1 class="text-4xl lg:text-5xl font-bold mb-4">ThrelteCanvas</h1>
		...
		<div class="p-8 bg-slate-900/50 backdrop-blur-sm rounded-xl border border-white/10">
			<div class="flex flex-wrap gap-4 items-center justify-center">
				<ThrelteCanvas>Preview</ThrelteCanvas>
				<ThrelteCanvas variant="secondary">Secondary</ThrelteCanvas>
				<ThrelteCanvas variant="ghost">Ghost</ThrelteCanvas>
			</div>
		</div>
	</section>
	...
	<section class="mb-16">
		...
		<ComponentPlayground component={ThrelteCanvas} props={playgroundProps} componentName="ThrelteCanvas" />
	</section>
						...
						<div class="grid lg:grid-cols-2 gap-8">
							<div class="space-y-4">
								...
								<div class="p-6 bg-slate-800/50 rounded-lg border border-white/10">
									...
									<ThrelteCanvas>Example</ThrelteCanvas>
								</div>
							</div>
							<div class="space-y-4">
