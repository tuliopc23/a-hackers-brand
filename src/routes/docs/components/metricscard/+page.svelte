<script lang="ts">
	...
	const examples = {
		basic: '<MetricsCard>\n  Content\n</MetricsCard>',
		variants:
			"<MetricsCard variant='glass'>\n  Glass\n</MetricsCard>\n<MetricsCard variant='terminal'>\n  Terminal\n</MetricsCard>\n<MetricsCard variant='liquid'>\n  Liquid\n</MetricsCard>",
		advanced:
			"<MetricsCard\n\tmetric={undefined}\n\tsize={'md'}\n\tvariant={'default'}\n\tlayout={undefined}\n>\n\tAdvanced Usage\n</MetricsCard>"
	};
	...
	const propsData = [
		...
		},
		{
			...
			optional: true,
			default: 'false',
			description: 'showTrend property'
		},
		{
			name: 'showChange',
			type: 'boolean',
			optional: true,
			default: 'false',
			description: 'showChange property'
		},
		{
			name: 'showIcon',
			type: 'boolean',
...
<svelte:head>
	<title>MetricsCard Component - A Hacker's Brand</title>
	<meta name="description" content="MetricsCard component with liquid glass effects and terminal aesthetics." />
</svelte:head>
...
<div class="docs-content">
	...
	<section class="mb-12">
		<div class="flex items-start justify-between mb-6">
			<div>
				<h1 class="text-4xl lg:text-5xl font-bold mb-4">MetricsCard</h1>
		...
		<div class="p-8 bg-slate-900/50 backdrop-blur-sm rounded-xl border border-white/10">
			<div class="flex flex-wrap gap-4 items-center justify-center">
				<MetricsCard>Preview</MetricsCard>
				<MetricsCard variant="secondary">Secondary</MetricsCard>
				<MetricsCard variant="ghost">Ghost</MetricsCard>
			</div>
		</div>
	</section>
	...
	<section class="mb-16">
		...
		<ComponentPlayground component={MetricsCard} props={playgroundProps} componentName="MetricsCard" />
	</section>
						...
						<div class="grid lg:grid-cols-2 gap-8">
							<div class="space-y-4">
								...
								<div class="p-6 bg-slate-800/50 rounded-lg border border-white/10">
									...
									<MetricsCard>Example</MetricsCard>
								</div>
							</div>
							<div class="space-y-4">
