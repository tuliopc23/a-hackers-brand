<script lang="ts">
	...
	const examples = {
		basic: '<PerformanceMonitor>\n  Content\n</PerformanceMonitor>',
		variants: '<PerformanceMonitor>\n  Content\n</PerformanceMonitor>',
		advanced:
			'<PerformanceMonitor\n\tshowWebVitals={true}\n\tshowFPS={true}\n\tshowMemory={true}\n\tupdateInterval={0}\n>\n\tAdvanced Usage\n</PerformanceMonitor>'
	};
	...
	const propsData = [
		{
			...
			optional: true,
			default: 'false',
			description: 'showWebVitals property'
		},
		{
			name: 'showFPS',
			type: 'boolean',
		...
		},
		{
			...
			optional: true,
			default: 'false',
			description: 'showMemory property'
		},
		{
			name: 'updateInterval',
			type: 'number',
			optional: true,
			default: '0',
			description: 'updateInterval property'
		},
		{
			name: 'position',
		...
		{
			name: 'theme',
			type: "'terminal' | 'cyberpunk' | 'minimal'",
			optional: true,
			default: 'undefined',
	...
	const playgroundProps = {
		...
		theme: {
			type: 'string',
			default: undefined,
			options: ['terminal', 'cyberpunk', 'minimal']
		},
		class: {
			type: 'string',
			default: '',
...
<svelte:head>
	<title>PerformanceMonitor Component - A Hacker's Brand</title>
	<meta name="description" content="PerformanceMonitor component with liquid glass effects and terminal aesthetics." />
</svelte:head>
...
<div class="docs-content">
	...
	<section class="mb-12">
		<div class="flex items-start justify-between mb-6">
			<div>
				<h1 class="text-4xl lg:text-5xl font-bold mb-4">PerformanceMonitor</h1>
		...
		<div class="p-8 bg-slate-900/50 backdrop-blur-sm rounded-xl border border-white/10">
			<div class="flex flex-wrap gap-4 items-center justify-center">
				<PerformanceMonitor>Preview</PerformanceMonitor>
				<PerformanceMonitor variant="secondary">Secondary</PerformanceMonitor>
				<PerformanceMonitor variant="ghost">Ghost</PerformanceMonitor>
			</div>
		</div>
	</section>
	...
	<section class="mb-16">
		...
		<ComponentPlayground component={PerformanceMonitor} props={playgroundProps} componentName="PerformanceMonitor" />
	</section>
						...
						<div class="grid lg:grid-cols-2 gap-8">
							<div class="space-y-4">
								...
								<div class="p-6 bg-slate-800/50 rounded-lg border border-white/10">
									...
									<PerformanceMonitor>Example</PerformanceMonitor>
								</div>
							</div>
							<div class="space-y-4">
