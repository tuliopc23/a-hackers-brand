<script lang="ts">
	...
	import AICommandSuggestions from '$lib/components/AICommandSuggestions.svelte';
	...
	const examples = {
		basic: '<AICommandSuggestions>\n  Content\n</AICommandSuggestions>',
		variants: '<AICommandSuggestions>\n  Content\n</AICommandSuggestions>',
		advanced:
	...
	const propsData = [
		...
		},
		{
			...
			optional: true,
			default: 'undefined',
			description: 'suggestions property'
		},
		{
			name: 'maxSuggestions',
			type: 'number',
			optional: true,
			default: '0',
			description: 'maxSuggestions property'
		},
		{
			name: 'showConfidence',
			type: 'boolean',
			optional: true,
			default: 'false',
			description: 'showConfidence property'
		},
		{
			name: 'showCategories',
			type: 'boolean',
			optional: true,
			default: 'false',
			description: 'showCategories property'
		},
		{
			name: 'theme',
			type: "'terminal' | 'cyberpunk' | 'neural'",
			optional: true,
			default: 'undefined',
	...
	const playgroundProps = {
		...
		theme: {
			type: 'string',
			default: undefined,
			options: ['terminal', 'cyberpunk', 'neural']
		},
		aiMode: {
			type: 'boolean',
			default: false,
...
<svelte:head>
	<title>AICommandSuggestions Component - A Hacker's Brand</title>
	<meta
		name="description"
		content="AICommandSuggestions component with liquid glass effects and terminal aesthetics."
	/>
</svelte:head>
...
<div class="docs-content">
	...
	<section class="mb-12">
		<div class="flex items-start justify-between mb-6">
			<div>
				<h1 class="text-4xl lg:text-5xl font-bold mb-4">AICommandSuggestions</h1>
		...
		<div class="p-8 bg-slate-900/50 backdrop-blur-sm rounded-xl border border-white/10">
			<div class="flex flex-wrap gap-4 items-center justify-center">
				<AICommandSuggestions>Preview</AICommandSuggestions>
				<AICommandSuggestions variant="secondary">Secondary</AICommandSuggestions>
				<AICommandSuggestions variant="ghost">Ghost</AICommandSuggestions>
			</div>
		</div>
	</section>
	...
	<section class="mb-16">
		...
		<ComponentPlayground
			component={AICommandSuggestions}
			props={playgroundProps}
			componentName="AICommandSuggestions"
		/>
	</section>
						...
						<div class="grid lg:grid-cols-2 gap-8">
							<div class="space-y-4">
								...
								<div class="p-6 bg-slate-800/50 rounded-lg border border-white/10">
									...
									<AICommandSuggestions>Example</AICommandSuggestions>
								</div>
							</div>
							<div class="space-y-4">
