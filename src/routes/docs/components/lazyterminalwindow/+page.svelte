<script lang="ts">
	...
	import LazyTerminalWindow from '$lib/components/LazyTerminalWindow.svelte';
	...
	const examples = {
		basic: '<LazyTerminalWindow>\n  Content\n</LazyTerminalWindow>',
		variants: '<LazyTerminalWindow>\n  Content\n</LazyTerminalWindow>',
		advanced:
			"<LazyTerminalWindow\n\ttitle={''}\n\tcommands={''}\n\tautoPlay={true}\n>\n\tAdvanced Usage\n</LazyTerminalWindow>"
	};
...
<svelte:head>
	<title>LazyTerminalWindow Component - A Hacker's Brand</title>
	<meta name="description" content="LazyTerminalWindow component with liquid glass effects and terminal aesthetics." />
</svelte:head>
...
<div class="docs-content">
	...
	<section class="mb-12">
		<div class="flex items-start justify-between mb-6">
			<div>
				<h1 class="text-4xl lg:text-5xl font-bold mb-4">LazyTerminalWindow</h1>
		...
		<div class="p-8 bg-slate-900/50 backdrop-blur-sm rounded-xl border border-white/10">
			<div class="flex flex-wrap gap-4 items-center justify-center">
				<LazyTerminalWindow>Preview</LazyTerminalWindow>
				<LazyTerminalWindow variant="secondary">Secondary</LazyTerminalWindow>
				<LazyTerminalWindow variant="ghost">Ghost</LazyTerminalWindow>
			</div>
		</div>
	</section>
	...
	<section class="mb-16">
		...
		<ComponentPlayground component={LazyTerminalWindow} props={playgroundProps} componentName="LazyTerminalWindow" />
	</section>
						...
						<div class="grid lg:grid-cols-2 gap-8">
							<div class="space-y-4">
								...
								<div class="p-6 bg-slate-800/50 rounded-lg border border-white/10">
									...
									<LazyTerminalWindow>Example</LazyTerminalWindow>
								</div>
							</div>
							<div class="space-y-4">
