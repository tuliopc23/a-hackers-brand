<script lang="ts">
	...
	const examples = {
		basic: '<PerformanceDashboard>\n  Content\n</PerformanceDashboard>',
		variants: '<PerformanceDashboard>\n  Content\n</PerformanceDashboard>',
		advanced: '<PerformanceDashboard\n\n>\n\tAdvanced Usage\n</PerformanceDashboard>'
	};
...
<svelte:head>
	<title>PerformanceDashboard Component - A Hacker's Brand</title>
	<meta
		name="description"
		content="PerformanceDashboard component with liquid glass effects and terminal aesthetics."
	/>
</svelte:head>
...
<div class="docs-content">
	...
	<section class="mb-12">
		<div class="flex items-start justify-between mb-6">
			<div>
				<h1 class="text-4xl lg:text-5xl font-bold mb-4">PerformanceDashboard</h1>
		...
		<div class="p-8 bg-slate-900/50 backdrop-blur-sm rounded-xl border border-white/10">
			<div class="flex flex-wrap gap-4 items-center justify-center">
				<PerformanceDashboard>Preview</PerformanceDashboard>
				<PerformanceDashboard variant="secondary">Secondary</PerformanceDashboard>
				<PerformanceDashboard variant="ghost">Ghost</PerformanceDashboard>
			</div>
		</div>
	</section>
						...
						<div class="grid lg:grid-cols-2 gap-8">
							<div class="space-y-4">
								...
								<div class="p-6 bg-slate-800/50 rounded-lg border border-white/10">
									...
									<PerformanceDashboard>Example</PerformanceDashboard>
								</div>
							</div>
							<div class="space-y-4">
