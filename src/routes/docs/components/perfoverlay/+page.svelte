<script lang="ts">
	...
	const examples = {
		basic: '<PerfOverlay>\n  Content\n</PerfOverlay>',
		variants: '<PerfOverlay>\n  Content\n</PerfOverlay>',
		advanced: '<PerfOverlay\n\n>\n\tAdvanced Usage\n</PerfOverlay>'
	};
...
<svelte:head>
	<title>PerfOverlay Component - A Hacker's Brand</title>
	<meta name="description" content="PerfOverlay component with liquid glass effects and terminal aesthetics." />
</svelte:head>
...
<div class="docs-content">
	...
	<section class="mb-12">
		<div class="flex items-start justify-between mb-6">
			<div>
				<h1 class="text-4xl lg:text-5xl font-bold mb-4">PerfOverlay</h1>
		...
		<div class="p-8 bg-slate-900/50 backdrop-blur-sm rounded-xl border border-white/10">
			<div class="flex flex-wrap gap-4 items-center justify-center">
				<PerfOverlay>Preview</PerfOverlay>
				<PerfOverlay variant="secondary">Secondary</PerfOverlay>
				<PerfOverlay variant="ghost">Ghost</PerfOverlay>
			</div>
		</div>
	</section>
	...
	<section class="mb-16">
		...
		<ComponentPlayground component={PerfOverlay} props={playgroundProps} componentName="PerfOverlay" />
	</section>
						...
						<div class="grid lg:grid-cols-2 gap-8">
							<div class="space-y-4">
								...
								<div class="p-6 bg-slate-800/50 rounded-lg border border-white/10">
									...
									<PerfOverlay>Example</PerfOverlay>
								</div>
							</div>
							<div class="space-y-4">
