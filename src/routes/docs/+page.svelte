...
<svelte:head>
	...
	<meta
		name="description"
		content="A jaw-dropping fusion of Apple's liquid glass design language with terminal hacker aesthetics. Interactive documentation and component showcase."
	/>
...
>
	...
	<section bind:this={heroSection} class="relative z-10 py-20 px-6">
		<div class="max-w-7xl mx-auto text-center">
			<div class="mb-8">
				<h1
					class="text-6xl md:text-8xl font-bold mb-6 bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent"
				>
					Design System
				</h1>
				<p class="text-xl md:text-2xl text-white/80 max-w-3xl mx-auto leading-relaxed">
					...
					with <strong class="text-green-400">terminal hacker aesthetics</strong>. Professional, innovative, and
					magnetic.
				</p>
			</div>
				...
				<GlassCard intensity="medium" class="p-6">
					<TerminalWindow title="tulio@brand-system">
						<div class="font-mono text-sm space-y-2">
							...
							<div class="text-blue-400">✓ Components installed successfully</div>
							<div class="text-purple-400">✓ Design tokens configured</div>
							<div class="text-green-400">✓ Ready to build jaw-dropping interfaces</div>
	...
	<section class="relative z-10 py-16 px-6">
		<div class="max-w-7xl mx-auto">
			<div class="text-center mb-12">
				...
				<p class="text-xl text-white/70">Comprehensive documentation and interactive examples</p>
			</div>
			...
			<div class="grid md:grid-cols-3 gap-8">
				{#each docSections as section (section.id || section)}
					<a href={section.href} class="group block" data-magnetic>
						<GlassCard
							intensity="light"
							class="p-8 h-full hover:intensity-medium transition-all duration-300 group-hover:scale-105"
						>
							<div
								class="flex items-center justify-center w-16 h-16 bg-gradient-to-r {section.color} rounded-xl mb-6 text-2xl group-hover:scale-110 transition-transform"
							>
								{section.icon}
							</div>
			...
			<GlassCard intensity="medium" class="p-8">
				...
				<div class="space-y-6">
					<div class="border-l-4 border-blue-500 pl-6">
						...
						<CodeHighlight code="npm install @tulio/liquid-glass-system" language="bash" />
					</div>
	...
	<footer class="relative z-10 py-8 px-6 mt-16 backdrop-blur-sm bg-white/5 border-t border-white/10">
		<div class="max-w-7xl mx-auto text-center">
			...
			<p class="text-white/50 text-sm mt-2">Liquid Glass Terminal Fusion Design System v0.2.0</p>
		</div>
	</footer>
</div>
