import { defineComponent, computed, ref, watchEffect, createElementBlock, openBlock, withDirectives, createElementVNode, vModelText, createCommentVNode, toDisplayString, createTextVNode, createVNode, withKeys, withModifiers, unref, Fragment, renderList, normalizeClass, createBlock } from "@histoire/vendors/vue";
        ...
        createElementVNode("label", _hoisted_3, [
          createElementVNode("span", _hoisted_4, [
            ...
            createElementVNode("span", _hoisted_6, [
              _cache[5] || (_cache[5] = createTextVNode(" Press ")),
              createVNode(_sfc_main$1, { shortcut: "Space" }),
              _cache[6] || (_cache[6] = createTextVNode(" to select "))
            ])
          ]),
          withDirectives(createElementVNode("input", {
            ref_key: "input",
