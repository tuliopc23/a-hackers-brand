import { defineComponent, reactive, ref, onMounted, createElementBlock, openBlock, withKeys, withModifiers, createElementVNode, toDisplayString, Fragment, renderList, createBlock, resolveDynamicComponent, createVNode, withCtx, nextTick } from "@histoire/vendors/vue";
...
import _sfc_main$1 from "./PromptSelect.vue2.js";
import _sfc_main$2 from "./PromptText.vue2.js";
import _sfc_main$3 from "../base/BaseButton.vue2.js";
import _sfc_main$4 from "../base/BaseKeyboardShortcut.vue2.js";
"use strict";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    function submit() {
      const params = props.command.getParams ? props.command.getParams({ ...getCommandContext(), answers }) : answers;
      ...
      return openBlock(), createElementBlock("form", {
        ...
        createElementVNode("div", _hoisted_2, [
          createVNode(_sfc_main$3, {
            ...
            default: withCtx(() => [
              createVNode(_sfc_main$4, { shortcut: "Enter" }),
              _cache[2] || (_cache[2] = createElementVNode("span", null, "Submit", -1))
            ]),
            _: 1
          })
        ])
