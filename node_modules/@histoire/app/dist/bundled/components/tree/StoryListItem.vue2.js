import { defineComponent, useCssVars, computed, ref, createElementBlock, openBlock, createVNode, withCtx, createElementVNode, createCommentVNode, unref, normalizeClass, toDisplayString } from "@histoire/vendors/vue";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    useCssVars((_ctx) => ({
      "2562213a": filePadding.value,
      "1eff521f": _ctx.story.iconColor
    }));
    const props = __props;
