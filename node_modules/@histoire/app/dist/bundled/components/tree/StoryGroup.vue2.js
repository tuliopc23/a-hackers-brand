import { defineComponent, computed, createElementBlock, openBlock, createCommentVNode, Fragment, createElementVNode, withKeys, createVNode, unref, toDisplayString, renderList, createBlock } from "@histoire/vendors/vue";
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        _ctx.group.title ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
          _cache[0] || (_cache[0] = createElementVNode("div", { class: "htw-h-[1px] htw-bg-gray-500/10 htw-mx-6 htw-mb-2 group-first:htw-hidden" }, null, -1)),
          createElementVNode("div", {
            ...
            createElementVNode("span", _hoisted_2, toDisplayString(_ctx.group.title), 1)
          ], 32)
        ], 64)) : createCommentVNode("", true),
        isFolderOpen.value ? (openBlock(), createElementBlock("div", _hoisted_3, [
