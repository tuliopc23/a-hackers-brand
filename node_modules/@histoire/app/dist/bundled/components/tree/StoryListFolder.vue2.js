import { defineComponent, useCssVars, computed, resolveComponent, createElementBlock, openBlock, createElementVNode, createCommentVNode, withKeys, createVNode, unref, normalizeClass, toDisplayString, Fragment, renderList, createBlock } from "@histoire/vendors/vue";
...
const _hoisted_2 = { class: "bind-tree-padding htw-flex htw-items-center htw-gap-2 htw-min-w-0" };
const _hoisted_3 = { class: "htw-flex htw-flex-none htw-items-center htw-opacity-30 [.histoire-story-list-folder-button:hover_&]:htw-opacity-100 htw-ml-4 htw-w-4 htw-h-4 htw-rounded-sm htw-border htw-border-gray-500/40" };
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        createElementVNode("div", {
          ...
          createElementVNode("span", _hoisted_2, [
            ...
            createElementVNode("span", _hoisted_4, toDisplayString(_ctx.folder.title), 1)
          ])
        ], 32),
