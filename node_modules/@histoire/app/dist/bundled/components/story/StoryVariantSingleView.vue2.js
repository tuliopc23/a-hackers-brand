import { defineComponent, createElementBlock, openBlock, createCommentVNode, createBlock, unref, createVNode } from "@histoire/vendors/vue";
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        !unref(isMobile) ? (openBlock(), createElementBlock("div", _hoisted_2, [
          ...
          _ctx.__HISTOIRE_DEV__ ? (openBlock(), createBlock(_sfc_main$5, {
            key: 1,
            file: _ctx.story.file?.filePath,
            tooltip: "Edit story in editor"
          }, null, 8, ["file"])) : createCommentVNode("", true)
        ])) : createCommentVNode("", true),
        _ctx.story.layout?.iframe === false ? (openBlock(), createBlock(_sfc_main$6, {
          key: 1,
          story: _ctx.story,
          variant: _ctx.variant
