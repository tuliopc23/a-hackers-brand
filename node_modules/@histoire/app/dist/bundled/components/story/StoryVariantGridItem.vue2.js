import { defineComponent, useCssVars, unref, toRefs, ref, computed, resolveComponent, resolveDirective, createElementBlock, openBlock, createElementVNode, withDirectives, createBlock, normalizeClass, withCtx, createVNode, toDisplayString, withModifiers, createCommentVNode, normalizeStyle } from "@histoire/vendors/vue";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    useCssVars((_ctx) => ({
      "60afaf4d": unref(variant).iconColor,
      "3bd99e7e": unref(settings).backgroundColor
    }));
    const props = __props;
    const emit = __emit;
