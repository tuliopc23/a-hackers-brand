import { defineComponent, computed, createBlock, unref, openBlock, withCtx, createElementVNode, createVNode, resolveDynamicComponent } from "@histoire/vendors/vue";
...
"use strict";
const _hoisted_1 = { class: "htw-flex htw-flex-col htw-h-full" };
    ...
    return (_ctx, _cache) => {
      return !unref(storyStore).currentVariant ? (openBlock(), createBlock(BaseEmpty, {
        ...
        default: withCtx(() => _cache[0] || (_cache[0] = [
          createElementVNode("span", null, "Select a variant", -1)
        ])),
        _: 1
