import { defineComponent, toRefs, computed, createBlock, openBlock, withCtx, createVNode, createTextVNode, normalizeClass, unref, createCommentVNode, toDisplayString } from "@histoire/vendors/vue";
      ...
      return openBlock(), createBlock(_sfc_main$1, { class: "histoire-pane-tabs htw-h-10 htw-flex-none htw-border-b htw-border-gray-100 dark:htw-border-gray-750" }, {
        overflow: withCtx(() => [
          ...
          createVNode(BaseOverflowTab, {
            ...
            default: withCtx(() => [
              _cache[5] || (_cache[5] = createTextVNode(" Events ")),
        ...
        default: withCtx(() => [
          ...
          createVNode(BaseTab, {
            ...
            default: withCtx(() => [
              _cache[2] || (_cache[2] = createTextVNode(" Events ")),
              unref(eventsStore).unseen ? (openBlock(), createBlock(BaseTag, { key: 0 }, {
                default: withCtx(() => [
                  createTextVNode(toDisplayString(unref(eventsStore).unseen <= 99 ? unref(eventsStore).unseen : "99+"), 1)
                ]),
