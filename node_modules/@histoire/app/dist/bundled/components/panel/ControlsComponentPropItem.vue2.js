import { defineComponent, computed, resolveDirective, createBlock, createCommentVNode, openBlock, resolveDynamicComponent, withCtx, withDirectives, createVNode, unref, withModifiers, normalizeClass } from "@histoire/vendors/vue";
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return comp.value ? (openBlock(), createBlock(resolveDynamicComponent(comp.value), {
        ...
        placeholder: model.value === void 0 ? _ctx.definition?.default : null,
