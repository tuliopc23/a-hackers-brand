import { defineComponent, useCssVars, computed, ref, watch, createElementBlock, openBlock, Fragment, createElementVNode, createVNode, renderList, toDisplayString, createTextVNode, unref, normalizeClass, withCtx } from "@histoire/vendors/vue";
...
const _hoisted_2 = { class: "htw-flex htw-items-center htw-gap-2" };
const _hoisted_3 = { class: "htw-opacity-40 htw-text-sm" };
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    useCssVars((_ctx) => ({
      "a3f02f4e": story.value?.iconColor
    }));
            ...
            story.value ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(folders.value, (file, key) => {
                return openBlock(), createElementBlock(Fragment, { key }, [
                  ...
                  _cache[0] || (_cache[0] = createElementVNode("span", { class: "htw-opacity-40" }, " / ", -1))
                ], 64);
              }), 128)),
              createElementVNode("span", _hoisted_2, [
                ...
                createElementVNode("span", _hoisted_3, toDisplayString(story.value.variants.length), 1)
              ])
