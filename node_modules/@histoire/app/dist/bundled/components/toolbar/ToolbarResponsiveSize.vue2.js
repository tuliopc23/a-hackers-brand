import { defineComponent, resolveComponent, resolveDirective, createBlock, openBlock, unref, withCtx, withDirectives, createElementBlock, normalizeClass, createVNode, createElementVNode, createTextVNode, vModelText, Fragment, renderList, toDisplayString, createCommentVNode } from "@histoire/vendors/vue";
...
const _hoisted_4 = { class: "htw-ml-auto htw-opacity-70 htw-flex htw-gap-1" };
        ...
        popper: withCtx(({ hide }) => [
          createElementVNode("div", _hoisted_1, [
            ...
            createElementVNode("div", _hoisted_2, [
              ...
              _cache[4] || (_cache[4] = createElementVNode("span", { class: "htw-opacity-50" }, "×", -1)),
              withDirectives(createElementVNode("input", {
            ...
            (openBlock(true), createElementBlock(Fragment, null, renderList(unref(histoireConfig).responsivePresets, (preset, index) => {
              return openBlock(), createElementBlock("button", {
                ...
                createElementVNode("span", _hoisted_4, [
                  preset.width ? (openBlock(), createElementBlock("span", _hoisted_5, [
