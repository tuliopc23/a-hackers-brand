...
var Spring = class _Spring {
  ...
  constructor(value, options = {}) {
    this.#current = dev_fallback_default ? tag(state(value), "Spring.current") : state(value);
    this.#target = dev_fallback_default ? tag(state(value), "Spring.target") : state(value);
