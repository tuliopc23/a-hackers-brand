<script lang="ts">import { Group } from 'three';
import { observe, T, useTask, useThrelte } from '@threlte/core';
import { useCubeCamera } from '../../hooks/useCubeCamera.svelte';
let { background = 'auto', far = 1000, fog = 'auto', frames = Infinity, near = 0.1, onupdatestart, onupdatestop, resolution = 256, children, ref = $bindable(), ...props } = $props();
