<script lang="ts">import { useStage, useTask, useThrelte } from '@threlte/core';
import { ThreePerf } from 'three-perf';
import { onDestroy } from 'svelte';
let { domElement = document.body, logsPerSecond = 10, showGraph = true, memory = true, enabled = true, visible = true, actionToCallUI = '', guiVisible = false, backgroundOpacity = 0.7, scale = 1, anchorX = 'left', anchorY = 'top' } = $props();
