<script lang="ts">import { AdditiveBlending, BufferAttribute, BufferGeometry, Color, Points, ShaderMaterial, Spherical, Vector3 } from 'three';
import { T, useTask } from '@threlte/core';
import { fragmentShader } from './fragment';
import { vertexShader } from './vertex';
let { count = 5000, radius = 50, depth = 50, factor = 6, saturation = 1.0, lightness = 0.8, speed = 1, fade = true, opacity = 1.0, ref = $bindable(), children, ...props } = $props();
