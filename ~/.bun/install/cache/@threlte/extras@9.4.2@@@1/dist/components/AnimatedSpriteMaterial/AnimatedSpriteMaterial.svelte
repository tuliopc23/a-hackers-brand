<script lang="ts">import { asyncWritable, isInstanceOf, T, useLoader, useParent, useTask, watch } from '@threlte/core';
import { DoubleSide, FileLoader, LinearFilter, MeshBasicMaterial, NearestFilter, RepeatWrapping, RGBADepthPacking, SpriteMaterial } from 'three';
import { useTexture } from '../../hooks/useTexture';
import { useSuspense } from '../../suspense/useSuspense';
let { textureUrl, dataUrl = '', animation = '', loop = true, autoplay = true, fps = 10, filter = 'nearest', alphaTest = 0.1, delay = 0, transparent = true, flipX = false, startFrame = 0, endFrame = undefined, rows = 1, columns = undefined, totalFrames = 0, is, ref = $bindable(), onload, onstart, onend, onloop, ...props } = $props();
