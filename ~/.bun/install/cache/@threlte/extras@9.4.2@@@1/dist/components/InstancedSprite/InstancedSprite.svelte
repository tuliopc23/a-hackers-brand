<script lang="ts">import { InstancedSpriteMesh } from '@threejs-kit/instanced-sprite-mesh';
...
let { autoUpdate = true, baseMaterial = MeshBasicMaterial, fps = 15, billboarding, playmode = 'FORWARD', count = 1000, alphaTest = 0.1, transparent = true, hueShift, randomPlaybackOffset = false, spritesheet, ref = $bindable(), children, ...props } = $props();
