import type { InstancedSpriteMesh, PLAY_MODE, SpritesheetFormat } from '@threejs-kit/instanced-sprite-mesh';
import type { Props } from '@threlte/core';
import type { Writable } from 'svelte/store';
import { InstancedMesh, Material, MeshBasicMaterial, MeshLambertMaterial, MeshPhongMaterial, MeshStandardMaterial, Texture, type Vector2Tuple, type Vector3Tuple } from 'three';
import type SpriteInstance from './SpriteInstance.svelte';
export type InstancedSpriteProps = Omit<Props<InstancedMesh, [{
    Instance: typeof SpriteInstance;
}]>, 'ref'> & {
    ref?: InstancedSpriteMesh<MeshBasicMaterial | MeshStandardMaterial | MeshLambertMaterial | MeshPhongMaterial, unknown>;
    /**
     ...
     */
    baseMaterial?: typeof MeshBasicMaterial | typeof MeshStandardMaterial | typeof MeshLambertMaterial | typeof MeshPhongMaterial;
    /**
