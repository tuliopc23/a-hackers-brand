...
test('can add and remove stages', () => {
    let Stages;
    (function (Stages) {
        Stages["stageA"] = "stage a";
        Stages["stageB"] = "stage b";
        Stages["stageC"] = "stage c";
    })(Stages || (Stages = {}));
    const scheduler = new Scheduler();
...
test('stress test', () => {
    ...
    defaultStage.createTask('move camera', () => {
        expect(i).toBe(3);
        i++;
    }, {
        after: 'move object'
    });
    defaultStage.createTask('trigger sounds', () => {
        expect(i).toBe(4);
        i++;
    }, {
        after: 'move camera'
    ...
    defaultStage.createTask('after other tasks', () => {
        expect(i).toBe(5);
        i++;
    }, {
...
test('stress test II', () => {
    ...
    let Stages;
    (function (Stages) {
        Stages["default"] = "default stage";
        Stages["render"] = "render stage";
        Stages["physics"] = "physics stage";
        Stages["frameStart"] = "frame analytics start";
        Stages["frameEnd"] = "frame analytics end";
        Stages["someOther"] = "some other stage";
        Stages["afterSomeOther"] = "after some other stage";
    })(Stages || (Stages = {}));
