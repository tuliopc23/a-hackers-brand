<script lang="ts">
	...
	let { title = 'Liquid Terminal', class: className = '', commands = {}, autoPlay = false, children }: Props = $props();
...
{:else if TerminalWindow}
	<svelte:component this={TerminalWindow} {title} class={className} {commands} {autoPlay} {children} />
{/if}
