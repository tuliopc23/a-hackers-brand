...
// Initial state
const initialConfig: ThrelteConfig = {
	enabled: false,
	scene: 'terminal',
	quality: 'medium',
	autoRotate: true,
...
// Main store
export const threlteConfig = writable<ThrelteConfig>(initialConfig);
...
export const threlteActions = {
	...
	setScene: (scene: 'glass' | 'terminal' | 'default') => {
	...
	updatePerformance: (stats: Partial<ThrelteConfig['performance']>) => {
