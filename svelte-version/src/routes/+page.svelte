<script lang="ts">
  import { Button, Card, Input, TerminalWindow } from '$lib';
...
<main class="min-h-screen">
  ...
  <section class="relative z-10 container mx-auto px-6 py-20">
    <div class="text-center mb-16">
      ...
      <h1 class="text-display-large font-bold mb-6 bg-gradient-to-r from-terminal-green via-brand-primary to-terminal-cyan bg-clip-text text-transparent">
        Liquid Glass Terminal Fusion
      </h1>
      
      <p class="text-body-large text-white/80 max-w-3xl mx-auto mb-8">
        A cutting-edge design system that seamlessly blends liquid glass morphism aesthetics with 
        terminal-inspired functionality. Built with <strong>SvelteKit + Vite</strong> for ultimate performance.
      </p>
    ...
    <div class="mb-20">
      <h2 class="text-heading-1 font-bold text-center mb-8 text-white">
        Interactive Terminal Experience
      </h2>
      <TerminalWindow 
        title="tulio@brand-system:~" 
        autoPlay={mounted}
    ...
    <!-- Component Showcase -->
    <div class="mb-20">
      <h2 class="text-heading-1 font-bold text-center mb-12 text-white">
        Glass UI Components
      </h2>
    ...
    <div class="text-center">
      <Card variant="glass-heavy" class="max-w-md mx-auto p-8">
        {#snippet children()}
          <h3 class="text-heading-3 font-semibold mb-4 text-white">
            Stay Updated
          </h3>
