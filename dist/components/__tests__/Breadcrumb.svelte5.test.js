...
import { createMockElement, createMockProps, simulateClassGeneration, simulateAnimation, simulateMouseEvent, expectClassesToContain, expectAttributesToBeSet, expectAriaAttributes, testAccessibilityCompliance, testEventCleanup } from './svelte5-test-utils';
describe('Breadcrumb Component (Svelte 5)', () => {
    ...
    describe('CSS Class Generation', () => {
        it('should generate correct container classes', () => {
            ...
            const variant = 'glass';
            simulateClassGeneration(container, 'flex items-center space-x-2', variant, '', [
                'text-white/80'
            ]);
    ...
    describe('Separator Rendering', () => {
        ...
        it('should apply separator styling', () => {
            const separator = createMockElement();
            const variant = 'glass';
            simulateClassGeneration(separator, 'mx-2', variant, '', [
                'text-white/40'
            ]);
            expectClassesToContain(separator, [
                'mx-2',
                'text-white/40'
            ]);
        });
