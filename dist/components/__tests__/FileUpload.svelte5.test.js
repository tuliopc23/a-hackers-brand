...
describe('FileUpload Component (Svelte 5)', () => {
    ...
    describe('CSS Class Generation', () => {
        it('should generate correct dropzone classes', () => {
            ...
            expectClassesToContain(dropzone, [
                'relative',
                'border-2',
                'border-dashed',
                'rounded-lg'
    ...
    describe('Upload Functionality', () => {
        ...
        it('should track upload progress', () => {
            const file = { id: '1', progress: 0, status: 'uploading' };
        ...
        it('should handle upload success', () => {
            const file = { id: '1', status: 'uploading' };
    ...
    describe('File Management', () => {
        ...
        it('should retry failed upload', () => {
            const file = { id: '1', status: 'error', error: 'Network error' };
    ...
    describe('Accessibility', () => {
        ...
        it('should announce file status changes', () => {
            ...
            const file = { name: 'test.jpg', status: 'success' };
