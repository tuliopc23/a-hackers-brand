...
describe('Accordion Component (Svelte 5)', () => {
    ...
    describe('CSS Class Generation', () => {
        it('should generate correct container classes', () => {
            ...
            expectClassesToContain(container, ['overflow-hidden', 'transition-all', 'glass-subtle', 'backdrop-blur-md']);
        });
        it('should generate correct header classes', () => {
            ...
            expectClassesToContain(header, ['w-full', 'flex', 'items-center', 'px-4', 'py-3']);
        });
