...
export declare function testVariants<T>(variants: string[], propsFactory: (variant: string) => T, testFn: (props: T, variant: string) => void): void;
export declare function testSizes<T>(sizes: string[], propsFactory: (size: string) => T, testFn: (props: T, size: string) => void): void;
export declare function simulateClassGeneration(element: MockElement, baseClass: string, variant?: string, size?: string, modifiers?: string[]): string;
export declare function simulateAnimation(element: MockElement, animated: boolean, duration?: number, easing?: string): void;
export declare function simulateMotionPreference(reducedMotion?: boolean): void;
export declare function simulateKeyboardEvent(element: MockElement, key: string, callback?: () => void): {
    key: string;
    preventDefault: import("vitest").Mock<(...args: any[]) => any>;
    stopPropagation: import("vitest").Mock<(...args: any[]) => any>;
};
export declare function simulateMouseEvent(element: MockElement, eventType: 'click' | 'mouseenter' | 'mouseleave' | 'mousedown' | 'mouseup', callback?: () => void): {
