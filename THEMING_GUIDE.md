...
.card-gradient {
  background: linear-gradient(135deg, 
    ...
    rgba(var(--brand-secondary-rgb), 0.1)
  );
...
/* Use with opacity */
.bg-primary-10 { background: rgba(var(--brand-primary-rgb), 0.1); }
.bg-primary-20 { background: rgba(var(--brand-primary-rgb), 0.2); }
.border-primary-30 { border-color: rgba(var(--brand-primary-rgb), 0.3); }
```
